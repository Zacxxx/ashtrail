    ...
    return (
        <div className="flex flex-col h-screen bg-[#1e1e1e] text-gray-300 font-sans tracking-wide overflow-hidden relative">
            ...
            <div className="flex-1 flex overflow-hidden relative z-10 pt-[80px] pb-12">
                {/* Left Sidebar Flow */}
                {activeStep !== "COMBAT" && activeStep !== "RULES" && activeStep !== "SKILLS" && (
                ...
                <div className={`flex-1 flex flex-col transition-all duration-500 ease-in-out h-full overflow-hidden ${activeStep === "CHARACTER" ? "ml-[510px]" : "ml-0"} ${activeStep !== "CHARACTER" && activeStep !== "COMBAT" && activeStep !== "SKILLS" && activeStep !== "RULES" ? "justify-center items-center" : ""}`}>
                    {activeStep === "CHARACTER" && (
