...
export function FactionsTab({ selectedWorld, setActiveTab }: FactionsTabProps) {
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            .catch(err => console.error("Failed to load factions and areas", err))
    ...
    return (
        <>
                        ...
                        <div className="flex-1 flex flex-col p-6 overflow-y-auto custom-scrollbar">
                                    ...
                                    >
                                        ...
                                        {areas.map(a => (
                                            <option key={a.id} value={a.name}>
                                                {a.name} {!a.rulingFaction || a.rulingFaction === "None" ? "(Unattributed)" : `(Ruled by ${a.rulingFaction})`}
                                            </option>
                                        ))}
                                    </select>
                                </div>
                            ...
                            <div className="flex flex-col gap-2 flex-1 relative">
                                ...
                                <textarea
                                    ...
                                    className="bg-[#05080c] border border-white/5 rounded-xl p-5 text-sm focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/20 focus:outline-none text-gray-300 w-full flex-1 min-h-[200px] custom-scrollbar shadow-inner leading-relaxed transition-all duration-300"
            ...
            <AiGenerateModal
                ...
                entityType="faction"
                existingItems={factions}
                onConfirm={(items) => {
                    const newFactions = [...factions, ...(items as Faction[])];
                    handleSave(newFactions);
                }}
            />
        </>
